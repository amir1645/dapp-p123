...
function updateTexts() {
  ...
  document.querySelector('#buy-miner') ? document.getElementById("buy-miner").textContent = t.buyMiner : null;
  document.querySelector('#withdraw-pool-btn') ? document.getElementById("withdraw-pool-btn").textContent = t.withdrawPoolBtn : null;
  document.querySelector('#withdraw-special-btn') ? document.getElementById("withdraw-special-btn").textContent = t.withdrawSpecialBtn : null;
}
