...
const translations = {
    fa: {
        ...
        installWallet: "لطفاً کیف پول (مثل MetaMask) را نصب کنید!",
        walletNotDetected: "کیف پول شناسایی نشد. لطفاً افزونه یا اپلیکیشن کیف پول را نصب کنید.",
...
async function register() {
    ...
    try {
        ...
        const estimatedGasCost = feeData.maxFeePerGas.mul(gasLimit);
