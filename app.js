...
const translations = {
  fa: {
    ...
    errorWithdraw: "خطا در برداشت: ",
    errorBuyMiner: "خطا در خرید توکن‌های ماینر: ",
    errorContribute: "خطا در مشارکت Miner Pool: ",
  ...
  ar: {
    ...
    errorWithdraw: "خطأ في السحب: ",
    errorBuyMiner: "خطأ في شراء توكنات الماينر: ",
    errorContribute: "خطأ في المساهمة في Miner Pool: ",
  ...
  en: {
    ...
    errorWithdraw: "Error in withdrawal: ",
    errorBuyMiner: "Error in buying miner tokens: ",
    errorContribute: "Error in contributing to Miner Pool: ",
